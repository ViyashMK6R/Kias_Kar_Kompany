...
namespace Kias_Kar_Kompany.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OwnerId,OwnerName,OwnerAddress,OwnerCellNumber,OwnerEmailAddress")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("OwnerId,OwnerName,OwnerAddress,OwnerCellNumber,OwnerEmailAddress")] Owner owner)
        {
            if (id != owner.OwnerId)
            {
                return NotFound();
